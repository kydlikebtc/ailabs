...
ai_config = AIConfig(default_model=default_config)
...
def sentiment_agent(state: AgentState):
    ...
    llm = create_llm(ai_config.get_model_for_agent('sentiment_agent'))
...
def risk_management_agent(state: AgentState):
    ...
    # Get the LLM for this agent
    llm = create_llm(ai_config.get_model_for_agent('risk_management_agent'))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model', type=str, default='gpt-4', help='Default AI model to use')
    parser.add_argument('--provider', type=str, default='openai', help='AI provider (openai/anthropic)')
